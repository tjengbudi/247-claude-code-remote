...
- replace 247.quivr.com with Docker self-host (local IP) (94718a9)

## [2.48.1] - 2026-07-01

### Bug Fixes

- **session**: auto-register tmux-only sessions on description PATCH (2c27e58)

## [2.48.0] - 2026-07-01

### Features

- **session**: edit description on mobile session cards (a926f36)
- **session**: v21 — human-readable session descriptions (2939686)

### Bug Fixes

- **session**: pass viewer identity on description PATCH + kill/archive (571acbb)

## [2.47.1] - 2026-07-01

### Bug Fixes

- **web**: pass description field in session mapping (712ef7b)
- **web**: add missing keys to AnimatePresence fragment children (7d88982)
